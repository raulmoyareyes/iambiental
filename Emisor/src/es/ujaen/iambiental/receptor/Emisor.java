...
import static es.ujaen.iambiental.daos.EmisorDAO.closeConexion;
import static es.ujaen.iambiental.daos.EmisorDAO.insertaDatosActuador;
import static es.ujaen.iambiental.daos.EmisorDAO.insertaDatosSensor;
import static es.ujaen.iambiental.daos.EmisorDAO.lecturaActuadorBD;
import static es.ujaen.iambiental.daos.EmisorDAO.openConexion;
import static es.ujaen.iambiental.daos.EmisorDAO.lecturaSensorBD;
...
public class Emisor {
    public static void main(String[] args) throws Exception {
        ...
        /*
        DatagramPacket paqueteEnvio = new DatagramPacket(datosEnvio, datosEnvio.length, DirecciónIP, 9876);
